        ...
        if ($result && $result->num_rows > 0) {
            ...
            elseif ($compte['solde'] < $montant) {
                ...
                if ($update->execute()) {
                    ...
                    $typeEvenement = "Retrait";
                    $message = "Retrait de $montant effectué du compte $idCompte via guichet $idGuichet.";
                    ...
                    $success = "Retrait de $montant  effectué avec succès.";
                } else {
...
<main class="d-flex justify-content-center align-items-center vh-100">
    <article class="form-container parent-Basic p-4 rounded shadow bg-light text-center" style="min-width: 350px;">
        <form action="" method="POST">
            <h3 class="mb-4">Effectuer un retrait</h3>
            ...
            <div class="mb-3 input-group">
                <input type="number" name="montant" class="form-control" placeholder="Montant à retirer" min="1" step="0.01" required>
            </div>
